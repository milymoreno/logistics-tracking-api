...
INSERT INTO states (code, name, description, is_final) VALUES
('CREATED', 'Creado', 'Guía creada en el sistema', FALSE),
('PICKED_UP', 'Recolectado', 'Paquete recolectado', FALSE),
('IN_TRANSIT', 'En tránsito', 'Paquete en movimiento', FALSE),
('OUT_FOR_DELIVERY', 'En reparto', 'Paquete en reparto final', FALSE),
('DELIVERED', 'Entregado', 'Paquete entregado exitosamente', TRUE),
('FAILED_DELIVERY', 'Entrega fallida', 'Intento de entrega fallido', FALSE),
('RETURNED', 'Devuelto', 'Paquete devuelto al remitente', TRUE),
...
CREATE TRIGGER update_unit_current_state_updated_at BEFORE UPDATE ON unit_current_state
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();